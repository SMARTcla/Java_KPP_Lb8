...
public class MetroServer extends Thread {
    ...
    public void run(){
        try{
            ...
            while (true){
                System.out.println(appender + "Customer expectation");
                Socket socket = serverSocket.accept();
                System.out.println(appender + "Client connected: " + socket.getInetAddress().getCanonicalHostName() + " at the port " + socket.getPort());
