...
public class Client {
    ...
    private void printMenu(){
        ...
        System.out.println("|| 1) Get card information              ||");
        ...
        System.out.println("|| 5) Pay for the fare(2000$)          ||");
        System.out.println("|| 6) Delete card                      ||");
    ...
    public void startInteraction(){
        ...
        while (choice != 7){
            ...
            switch (choice){
                ...
                default:
                    System.out.println("Input Error. Repeat request.");
                    cardOperation = null;
                    break;
            }
    ...
    private String readCardSerialNumber(Scanner in){
        System.out.print("Enter the serial number of the card: ");
        return in.next();
    }
    ...
    private MetroCard readCard(Scanner in){
        ...
        System.out.print("Enter an educational institution: ");
